public class Main {
	public static void main(String[] args) {
		...
		a.setValue(100); // Кэширование, следовательно a1(100) сравнение 100 это один и тот же объект при сравнении == будет выводить true и при .equals тоже true
		a.compareWith(100);

		// Сценарий Б:
		ItemStorage<Integer> b = new ItemStorage<>();
		b.setValue(200); // Тут уже кэширование нет, поэтому значения больше чем 127, являются отдельными объектами, при .equals будет true, при == false
		b.compareWith(200);
